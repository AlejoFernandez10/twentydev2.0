...
<div className=" w-full min-h-[100vh] flex flex-col justify-center bg-[#0B1325]">
  <h2 className=" text-center  text-[30px] sm:text-[35px] lg:text-[43px] mb-[60px] bg-gradient-to-r from-[#4EA4CD]  to-[#9FF9FF] bg-clip-text text-transparent" >Nuestros servicios</h2>
  ...
  <div className="max-w-[1200px] w-full m-auto flex flex-col justify-center items-center ">
    ...
    <div className='w-[95%] flex flex-col justify-center items-center md:flex-row-reverse '  style={{marginTop:"40px"}}>
      <div className='m-auto h-[20vh] md:h-[30vh]    w-50% text-[#94A3B8] flex flex-col justify-evenly items-center'>
      ...
      <img srcSet={nosotrosPagWeb} className="mt-5 w-[50%] max-h-[420px]"  alt="colaboraciones imagen" />
    </div>
